 ...
 */
public final class Utilities { //add public by linmaoqing 2014-5-12
     ...
     */
    public static Bitmap createIconBitmap(Drawable icon, Context context) { //add public by linmaoqing 2014-5-12

 ...
 */
package com.android.launcher3.floatmenu;
...
import com.android.launcher3.floatmenu.animation.DefaultAnimationHandler;
import com.android.launcher3.floatmenu.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    private boolean isFolderCell;
    private int[] folderPoint = new int[2];
	...
	public void setFolderCell(boolean isFolderCell) {
		this.isFolderCell = isFolderCell;
	}
    ...
    public FloatingActionMenu(final View mainActionView,
                              ...
                              final boolean systemOverlay, MenuItemClickListener listener) {
...
//        this.mainActionView.setOnClickListener(new ActionViewClickListener());
        ...
        for(final Item item : subActionItems) {
            if(item.width == 0 || item.height == 0) {
                ...
                //menuitem添加监听
                item.view.setOnClickListener(new ActionViewClickListener());
            }
        }
    ...
    private Point getActionViewCoordinates() {
    	int oriention = mainActionView.getContext().getResources().getConfiguration().orientation;
        ...
        if(!isFolderCell()){
        	...
        	coords[0] = folderPoint[0];
        	coords[1] = folderPoint[1];
        }
        ...
        if(systemOverlay) {
			...
			if (oriention == Configuration.ORIENTATION_PORTRAIT) {
				coords[0] -= (getScreenSize().x - getActivityContentView().getMeasuredWidth());
			} else if (oriention == Configuration.ORIENTATION_LANDSCAPE) {
    ...
    public class ActionViewClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
        	if(menuItemClickListener != null){
        		menuItemClickListener.onMenuItemClick(v);
        	}
            toggle(animated);
        }
    }
     ...
     * A simple click listener used by the main action view
     */
    public class ActionViewLongClickListener implements View.OnLongClickListener {

		@Override
		public boolean onLongClick(View v) {
			Log.e("", "ActionViewLongClickListener-----onLongClick---- v = " +v);
			toggle(animated);
			return false;
		}
    }

    public interface MenuItemLongClickListener{
    	void onMenuItemLongClick(View v);
    }
...
//    MenuOnTouchListener menuOnTouchListener;
//    public void setMenuOnTouchListener(MenuOnTouchListener listener){
//    	menuOnTouchListener = listener;
//    }
//    public class MenuOnTouchListener implements OnTouchListener{
//
//		@Override
//		public boolean onTouch(View v, MotionEvent event) {
//			if(!(v instanceof FloatingActionButton) || !(v instanceof SubActionButton)){
//				close(true);
//			}
//			return false;
//		}
...
//            endAngle = 270;
        ...
        public Builder setMenuItemClickListener(MenuItemClickListener listener){
        	this.menuItemClickListener = listener;
        	return this;
        }
        ...
        public FloatingActionMenu build() {
            return new FloatingActionMenu(actionView,
                                          ...
                                          animated,
                                          stateChangeListener,
                                          systemOverlay,menuItemClickListener);
        }
    }

...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, LayoutParams contentParams,int id, Object tag) {
        super(context);

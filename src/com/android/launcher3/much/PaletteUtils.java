...
public class PaletteUtils {
	...
	public static List<String> sortToHslBySection(
		...
		for (Map.Entry<String, Bitmap> entry : appIconMaps.entrySet()) {
	...
	private static List<String> sortAppIcon(HashMap<String, float[]> hslMaps,
		...
		List<HashMap.Entry<String, float[]>> entryList = new ArrayList<HashMap.Entry<String, float[]>>(hslMaps.entrySet());
		Collections.sort(entryList,
				new Comparator<HashMap.Entry<String, float[]>>() {

...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, FrameLayout.LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, FrameLayout.LayoutParams contentParams,int id, Object tag) {
        super(context);
    ...
    public static class Builder {
        ...
        public Builder setTag(Object data){
        	this.tag = data;
        	return this;
        }
